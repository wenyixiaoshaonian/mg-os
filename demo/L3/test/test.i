...
int main() {
    student[0] = student_create(0,26,"xiaoming",1); student[1] = student_create(1,22,"xiaohua",0); student[2] = student_create(2,21,"jianjun",1); student[3] = student_create(3,24,"aiguo",1);;
    for(int i=0;i<4;i++) {
